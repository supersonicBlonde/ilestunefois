...
<div class="sib-form" style="text-align: center;">
  <div id="sib-form-container" class="sib-form-container">
    <div id="error-message" class="sib-form-message-panel" style="font-size:16px; text-align:left; color:red;max-width:630px;">
        ...
        <div class="row">
            ...
            <div style="padding: 8px 0;">
              <div class="sib-input sib-form-block">
                <div class="form__entry entry_block">
                  ...
                  <label class="entry__error entry__error--primary" style=" text-align:left;">
                  </label>
                </div>
              </div>
            </div>
          ...
          <div class="sib-form-block" style="text-align: left">
            <div class="sib-form-block submit-container" style="text-align: center">
              <button class="sib-form-block__button sib-form-block__button-with-loader" style="text-align:left;" form="sib-form"
                type="submit">
              ...
              <div class="form__label-row ">
                <div class="entry__choice">
                  <label>
                    ...
                    <span class="checkbox checkbox_tick_positive"></span><span style=" text-align:left;"><p style="color:rgba(255, 255, 255, 0.5);">Je consens à recevoir la newsletter ilestunefois et j'accepte la politique de confidentialité.</p></span>                    </label>
                </div>
              </div>
              <label class="entry__error entry__error--primary" style=" text-align:left;">
              </label>
